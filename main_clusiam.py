...
parser.add_argument('--fix_pred_lr', action='store_false', type=bool, help='Fix predictor learning rate')
...
def main():
    ...
    def train(train_loader, model, criterion, optimizer, epoch):
        ...
        for i, images in enumerate(train_loader):
            ...
            contrastive_loss = -(criterion(p[0], z[1].detach()).mean() + criterion(p[1], z[0].detach()).mean()) * (1 - args.alpha)  #SimSiam
